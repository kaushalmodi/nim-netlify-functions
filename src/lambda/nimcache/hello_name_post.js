...
function nimCopyAux(dest_322635, src_322636, n_322638) {
		...
		case 2:
			L1: do {
				var i_323024 = 0;
				var colontmp__463884 = 0;
				colontmp__463884 = (n_322638.len - 1);
				var res_463886 = 0;
				L2: do {
						L3: while (true) {
						if (!(res_463886 <= colontmp__463884)) break L3;
							i_323024 = res_463886;
...
async function HEX3Aanonymous_463060(event_463062, context_463063) {
		...
		function inner_463131() {
			...
			BeforeRet: do {
				...
				a_463134 = {};
				F.line = 434;
				a_463134.statusCode = 405;
				F.line = 434;
				a_463134.body = makeNimstrLit("Method Not Allowed");
				F.line = 443;
		...
		function inner_463487() {
			var result_463489 = null;
			...
			BeforeRet: do {
				...
				a_463490 = {};
				F.line = 434;
				a_463490.statusCode = 200;
				F.line = 434;
				a_463490.body = toJSStr((makeNimstrLit("Hello, ")).concat(name_463478,makeNimstrLit("! From Nim.")));
				F.line = 443;
				result_463489 = a_463490;
				break BeforeRet;
			} while (false);
			framePtr = F.prev;

			return result_463489;

		}

	var result_463074 = null;

	var F={procname:"hello_name_post.:anonymous",prev:framePtr,filename:"hello_name_post.nim",line:0};
	framePtr = F;
	BeforeRet: do {
		F.line = 14;
		var http_method_463107 = cstrToNimstr((event_463062.httpMethod));
		if (!(eqStrings(http_method_463107, makeNimstrLit("POST")))) {
		F.line = 16;
		result_463074 = inner_463131();
		break BeforeRet;
		}
		
		F.line = 22;
		var params_463463 = querystring.parse((event_463062.body));
		F.line = 24;
		var name_463478 = cstrToNimstr((params_463463.name));
		if (eqStrings(name_463478, [])) {
		F.line = 26;
		name_463478 = nimCopy(null, makeNimstrLit("World"), NTI305040);
		}
		
		F.line = 28;
		result_463074 = inner_463487();
		break BeforeRet;
	} while (false);
	framePtr = F.prev;

	return result_463074;

}
import "querystring" from '"querystring"';
exports.handler = HEX3Aanonymous_463060;
