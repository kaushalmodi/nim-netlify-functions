...
async function HEX3Aanonymous_463083(event_463085, context_463086) {

		function inner_463130() {
			var result_463132 = null;
			...
			BeforeRet: do {
				...
				a_463133 = {};
				F.line = 434;
				a_463133.statusCode = 200;
				F.line = 434;
				a_463133.body = toJSStr(greeting_463042);
				F.line = 443;
				result_463132 = a_463133;
				break BeforeRet;
			} while (false);
			framePtr = F.prev;

			return result_463132;

		}

	var result_463097 = null;

	var F={procname:"hello_env.:anonymous",prev:framePtr,filename:"hello_env.nim",line:0};
	framePtr = F;
	BeforeRet: do {
		F.line = 10;
		result_463097 = inner_463130();
		break BeforeRet;
	} while (false);
	framePtr = F.prev;

	return result_463097;

}
var greeting_463042 = cstrToNimstr((process.env.GREETING));
exports.handler = HEX3Aanonymous_463083;
